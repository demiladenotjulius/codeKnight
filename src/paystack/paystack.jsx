        ...
        <Slide left>
          <div className="flex flex-col items-start md:items-center w-full mx-auto max-w-[1440px] gap-10 md:gap-32">
            <div className="w-full md:w-[570px] flex flex-col">
              ...
              >
                <a
                  href="hhttps://github.com/demiladenotjulius/Paystack_Integration"
                  target="_blank"
                >
                  Visit Paystack gateway
                </a>
              </motion.button>
              <p className="w-full break-words text-xl mt-6 leading-8">
                Experience seamless transactions, secure and reliable with
                Paystack payment gateway.
              </p>
              <p className="w-full break-words opacity-65 mt-8 leading-8">
                Discover the ease and security of our seamless payment gateway,
                ensuring your transactions are safe, simple, and reliable
              </p>
