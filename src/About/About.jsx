        ...
        <div className="w-full bg-light-pink relative">
            ...
            <div className='w-full px-6  lg:px-32 bg-custom-dark md:pt-40 pt-36 pb-24 text-white '>
                <div className='flex flex-col w-full items-center mx-auto max-w-[1440px] py-4 md:gap-6 gap-4'>
                    ...
                    "I provide a full range of services, including software development, technical skills, and research."
                    </p>
                </div>
            </div>
                    ...
                    <Slide left>
                        <div className='w-full flex flex-col md:items-center gap-3'>
                            <div className='w-full'>
                                <img src='/about/hero.png' className='w-full' />
                            </div>
                            <div className='flex flex-col break-words w-full md:w-[500px]'>
                                <p className='uppercase text-custom-orange'>Demilade julius</p>
                                <h3 className='md:text-[56px] text-[40px] tracking-[-1px] leading-[64px] font-extrabold'>Software Engineer</h3>
                            </div>
                            <p className='w-full break-words opacity-65'>
                                I am DAMILADE JULIUS, a passionate web developer with over five years of experience crafting seamless and innovative web solutions. My journey into the world of coding started with a simple HTML tutorial, and it quickly blossomed into a full-fledged career that I absolutely love.<br />
                                My expertise spans across front-end and back-end development, with a particular fondness for creating interactive and user-friendly interfaces. I’m well-versed in HTML, CSS, JavaScript, and various frameworks such as React and Next Js for front-end development. On the back-end, I’m proficient with Node.js, Express, and databases like MongoDB and SQL.<br />
                                I thrive on challenges and am always eager to learn and adapt to new technologies. My portfolio includes diverse projects ranging from e-commerce websites to sophisticated web applications, all designed with a keen eye for detail and a strong emphasis on performance and scalability.<br />
                                Coming from an average background family with little hope for the future, learning to code changed my life for the better. I'm truly grateful for the opportunities it has provided me, and I'm passionate about helping children from poor families transform their lives through coding and technology. <br />
                                When I’m not coding, you can find me exploring the latest tech trends, contributing to open-source projects, or enjoying a good book with a cup of coffee and sometimes, i'm on netflix. I believe in the power of community and collaboration, and I’m always excited to connect with fellow developers and tech enthusiasts.
                    ...
                    <Slide right>
                        <div className='w-full flex flex-col md:items-center gap-3 md:mt-32 mt-9 pb-4 md:pb-16'>
                            <div className='w-full md:w-[530px] flex flex-col items-center gap-3'>
                                <h3 className='text-[40px] tracking-[-1px] leading-[64px] font-extrabold'>Unlock The Greatest Value<br /> Possible</h3>
                                <p className='opacity-65 break-words w-full'>
                                    "through innovative web development solutions, transforming your digital presence into a powerful asset."
                                </p>
                                ...
                                <p className='opacity-65 break-words w-full'>
                                Ability to understand the client's perspective. I aim to partner for the long term, acting as an extension of the client's team.                                </p>
                                <p className='opacity-65 break-words w-full'>
                                As a software developer, I provide businesses with a variety of development solutions to build and enhance their products or services and support their technology goals.</p>                            </div>
                        </div>
                    </Slide>
                    <Slide bottom>
            ...
            <div className='w-full px-6  lg:px-32 bg-light-grey pt-10 md:pt-16 pb-20 md:pb-12  '>
                <div className='flex md:flex-row flex-col w-full md:items-center mx-auto max-w-[1440px] gap-8 md:gap-20 lg:gap-40 md:justify-between'>
                    <div className='gap-3 flex flex-col'>
                        <p className='uppercase text-custom-orange'>
                            Get Started
                        </p>
