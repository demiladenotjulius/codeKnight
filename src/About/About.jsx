            ...
            <div className='w-full px-6  lg:px-32 bg-custom-dark md:pt-40 pt-36 pb-24 text-white '>
                <div className='flex flex-col w-full items-center mx-auto max-w-[1440px] py-4 md:gap-6 gap-4'>
                    ...
                    <p className='text-center w-full md:w-[45%]'>
                        I provides a full service range including technical skills, design, research.
                    </p>
                </div>
            </div>
                    ...
                    <Slide left>
                        <div className='w-full flex flex-col md:items-center gap-3'>
                            ...
                            <div className='flex flex-col break-words w-full md:w-[500px]'>
                                <p className='uppercase text-custom-orange'>Damilade julius</p>
                                <h3 className='md:text-[56px] text-[40px] tracking-[-1px] leading-[64px] font-extrabold'>Professional Web Developer</h3>
                            </div>
                            <p className='w-full break-words opacity-65'>
                                ...
                                My expertise spans across front-end and back-end development, with a particular fondness for creating interactive and user-friendly interfaces. I’m well-versed in HTML, CSS, JavaScript, and various frameworks such as React and Angular for front-end development. On the back-end, I’m proficient with Node.js, Python, and databases like MongoDB and SQL.<br />
                                ...
                                When I’m not coding, you can find me exploring the latest tech trends, contributing to open-source projects, or enjoying a good book with a cup of coffee. I believe in the power of community and collaboration, and I’m always excited to connect with fellow developers and tech enthusiasts.
                        ...
                        <div className='border-t border-b border-light-grey w-full flex flex-col md:pt-32 pt-16 md:pb-48 pb-6'>
                            <div className='flex flex-col w-full md:w-[800px]  md:mx-auto '>
                                <div className='flex justify-between w-full'>
                                    <p className=' text-custom-orange'>Damilade’s Words</p>
                                ...
                                <p className='w-full break-words font-extrabold text-[40px] leading-[48px] md:mt-10 mt-5'>
                                    "Crafting code, shaping dreams: Transforming ideas into digital reality, one pixel at a time."
                                </p>
