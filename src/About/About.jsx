                    ...
                    <Slide left>
                        <div className='w-full flex flex-col md:items-center gap-3'>
                            ...
                            <p className='w-full break-words opacity-65'>
                                I am DEMILADE JULIUS, a passionate web developer with over five years of experience crafting seamless and innovative web solutions. My journey into the world of coding started with a simple HTML tutorial, and it quickly blossomed into a full-fledged career that I absolutely love.<br />
