                        ...
                        <div className='w-full flex md:flex-row flex-col gap-4'>
                            ...
                            <div className='flex flex-col w-full md:w-[60%]'>
                                <div
                                    ...
                                    className={`${isClickFirst ? 'bg-white' : ''} rounded-t-md border border-light-grey py-10 md:px-12 px-7 md:gap-9 cursor-pointer w-full flex flex-col gap-8`}>
                                ...
                                <div
                                    ...
                                    className={`${isClickSecond ? 'bg-white' : ''} rounded-t-md border border-light-grey py-10 md:px-12 px-7 md:gap-9 cursor-pointer w-full flex flex-col gap-8`}>
                                    <div className='w-full flex justify-between items-center'>
                                        <p className='font-bold text-2xl'>
                                ...
                                <div
                                    ...
                                    className={`${isClickThird ? 'bg-white' : ''} rounded-t-md border border-light-grey py-10 md:px-12 px-7 md:gap-9 cursor-pointer w-full flex flex-col gap-8`}>
                                    <div className='w-full flex justify-between items-center'>
                                        <p className='font-bold text-2xl'>
